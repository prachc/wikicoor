...
public class WikiCoor3 extends HttpServlet {
	...
	private Thread threadWiki2;
	private String Wiki2_Lat2H;
	private String Wiki2_Lat2M;
	private String Wiki2_Lat2S;
	private String Wiki2_Lng2H;
	private String Wiki2_Lng2M;
	private String Wiki2_Lng2S;
	private IntentBroadcastReceiver IBReceiver_Wiki2;
	private static final int WA_Wiki2_SUCCEED = 0xF01;
	private static final int WA_Wiki2_FAILED = 0xF0F;
				...
				mHandler = new Handler() {
					...
					public void handleMessage(Message msg){
						...
						case WA_Wiki1_FAILED:
							...
							break;
						case WA_Wiki2_SUCCEED:
							stopThread(threadWiki2);
							prepareToLat2MDec();
							prepareToLat2SDec();
							prepareToLng2MDec();
							prepareToLng2SDec();
						...
						case OUTPUT:
							...
							tempBundle.putString("Lat2H", Wiki2_Lat2H);
							tempBundle.putString("Lat2M", Wiki2_Lat2M);
							tempBundle.putString("Lat2S", Wiki2_Lat2S);
							tempBundle.putString("Lng2H", Wiki2_Lng2H);
							tempBundle.putString("Lng2M", Wiki2_Lng2M);
							tempBundle.putString("Lng2S", Wiki2_Lng2S);
	...
	public void prepareToLat2MDec(){
		threadToLat2MDec = new Thread(new Runnable() {
			public void run() {
				Lat2MDec = ARFunction.mintoDec(Wiki2_Lat2M);
	...
	public void prepareToLng2MDec(){
		threadToLng2MDec = new Thread(new Runnable() {
			public void run() {
				Lng2MDec = ARFunction.mintoDec(Wiki2_Lng2M);
	...
	public void prepareToLat2SDec(){
		threadToLat2SDec = new Thread(new Runnable() {
			public void run() {
				Lat2SDec = ARFunction.sectoDec(Wiki2_Lat2S);
	...
	public void prepareToLng2SDec(){
		threadToLng2SDec = new Thread(new Runnable() {
			public void run() {
				Lng2SDec = ARFunction.sectoDec(Wiki2_Lng2S);
	...
	public void prepareSumLat2(){
		threadSumLat2 = new Thread(new Runnable() {
			public void run() {
				SumLat2 = ARFunction.sum(Wiki2_Lat2H,Lat2MDec,Lat2SDec);
	...
	public void prepareSumLng2(){
		threadSumLng2 = new Thread(new Runnable() {
			public void run() {
				SumLng2 = ARFunction.sum(Wiki2_Lng2H,Lng2MDec,Lng2SDec);
	...
	public void prepareWiki1(){
		threadWiki1 = new Thread(new Runnable() {
			public void run() {
				//String URL = "http://en.m.wikipedia.org/w/index.php?title=Shibuya_Station&mobileaction=view_normal_site";
				String URL = "http://en.wikipedia.org/w/index.php?title=Shibuya_Station";
				...
				scripts[0] = 
				    ...
				    "    if(i>=10&&i<30&&tagArray1[i].className=='geo-dms'){"+
				    ...
				    "Lat1M.push(Lat1[0].split('°')[1].split('′')[0]);"+
				    "Lat1S.push(Lat1[0].split('°')[1].split('′')[1].split('″')[0]);"+
				    ...
				    "Lng1M.push(Lng1[0].split('°')[1].split('′')[0]);"+
				    "Lng1S.push(Lng1[0].split('°')[1].split('′')[1].split('″')[0]);"+
				   ...
				   /* "var Lat2 = new Array();"+
				    ...
				    "Lat2M.push(Lat2[0].split('°')[1].split('′')[0]);"+
				    "Lat2S.push('0');"+
				    ...
				    "Lng2M.push(Lng2[0].split('°')[1].split('′')[0]);"+
				    "Lng2S.push('0');"+
	...
	public Runnable iFinished_Wiki1 = new Runnable() {
	 ...
	 public void prepareWiki2(){
		threadWiki2 = new Thread(new Runnable() {
			public void run() {
				//String URL = "http://en.m.wikipedia.org/w/index.php?title=Meiji_Shrine&mobileaction=view_normal_site";
				String URL = "http://en.wikipedia.org/w/index.php?title=Meiji_Shrine";
				...
				scripts[0] = 
				    ...
				    */
				    ...
				    "var parentElement;"+
				    "for(var i=0;i<tagArray1.length;i++){"+
				    "    if(i>=74&&i<94&&tagArray1[i].className=='geo-dms'){"+
				    "        parentElement = tagArray1[i];"+
				    "        break;"+
				    "    }"+
				    "}"+
				...
				IBReceiver_Wiki2 = new IntentBroadcastReceiver();
				Intent intent = new Intent("com.prach.mashup.SMA");
				intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				...
				String[] msg = {"com.prach.mashup.WAExtractor",
						...
						"EXTRA:URL",URL,
						"EXTRAS:SCRIPTS",Function.genExtrasString(scripts)};
				IBReceiver_Wiki2.ResultArrayNameVector.add("OUTPUTS"); //0
				IBReceiver_Wiki2.ResultArrayNameVector.add("NAMES"); //1
				intent.putExtra("MSG", msg);

				IntentFilter IFfinished = new IntentFilter("com.prach.mashup.FINISHED");
				androidContext.registerReceiver(IBReceiver_Wiki2,IFfinished,null,null);
				IBReceiver_Wiki2.ProcessNumber = 0x001;
				IBReceiver_Wiki2.handler = iHandler;
				IBReceiver_Wiki2.finish = iFinished_Wiki2;
	...
	public Runnable iFinished_Wiki2 = new Runnable() {
		public void run(){
			if(IBReceiver_Wiki2.ProcessNumber == 0x001){
				stopThread(threadWiki2);
				androidContext.unregisterReceiver(IBReceiver_Wiki2);

				int count_resultname = IBReceiver_Wiki2.ResultNameVector.size();
				int count_resultarrayname = IBReceiver_Wiki2.ResultArrayNameVector.size();
				int allcount = count_resultarrayname + count_resultname;
				...
				if(IBReceiver_Wiki2.ResultStringVector.get(0).equals("RESULT_OK")){
					debug("result OK");
					resultstrings = new String[allcount][];

					for (int i = 0; i < count_resultname; i++){
						resultstrings[i] = new String[1];
						resultstrings[i][0] = IBReceiver_Wiki2.ResultStringVector.get(i+1);
					}
					for (int i = count_resultname; i < allcount; i++) {
						resultstrings[i] = IBReceiver_Wiki2.ResultStringArrayVector.get(i-count_resultname);
					}

					
					
					
					Wiki2_Lat2H = Function.getStringByName(
							resultstrings[IBReceiver_Wiki2.getArrayIndexfromName("OUTPUTS")], 
							resultstrings[IBReceiver_Wiki2.getArrayIndexfromName("NAMES")], 
					"Lat2H");
					Wiki2_Lat2M = Function.getStringByName(
							resultstrings[IBReceiver_Wiki2.getArrayIndexfromName("OUTPUTS")], 
							resultstrings[IBReceiver_Wiki2.getArrayIndexfromName("NAMES")], 
					"Lat2M");
					Wiki2_Lat2S = Function.getStringByName(
							resultstrings[IBReceiver_Wiki2.getArrayIndexfromName("OUTPUTS")], 
							resultstrings[IBReceiver_Wiki2.getArrayIndexfromName("NAMES")], 
					"Lat2S");
					Wiki2_Lng2H = Function.getStringByName(
							resultstrings[IBReceiver_Wiki2.getArrayIndexfromName("OUTPUTS")], 
							resultstrings[IBReceiver_Wiki2.getArrayIndexfromName("NAMES")], 
					"Lng2H");
					Wiki2_Lng2M = Function.getStringByName(
							resultstrings[IBReceiver_Wiki2.getArrayIndexfromName("OUTPUTS")], 
							resultstrings[IBReceiver_Wiki2.getArrayIndexfromName("NAMES")], 
					"Lng2M");
					Wiki2_Lng2S = Function.getStringByName(
							resultstrings[IBReceiver_Wiki2.getArrayIndexfromName("OUTPUTS")], 
							resultstrings[IBReceiver_Wiki2.getArrayIndexfromName("NAMES")], 
					"Lng2S");
					mHandler.sendEmptyMessage(WA_Wiki2_SUCCEED);
					
				}else if(IBReceiver_Wiki2.ResultStringVector.get(0).equals("RESULT_CANCELED")){
					debug("result CXL");
					resultstrings = new String[allcount][];
					for (int i = 0; i < count_resultname; i++){
						resultstrings[i] = new String[1];
					...
					mHandler.sendEmptyMessage(WA_Wiki2_FAILED);
