...
public class AmazonPrice1 extends HttpServlet {
				...
				mHandler = new Handler() {
					...
					public void handleMessage(Message msg){
						...
						case WA_AmazonJP_SUCCEED:
							...
							tempBundle.putString("ProductPrice", AmazonUS_ProductPrice);
						...
						case WS_ExchangeRateUSJP_SUCCEED:
		                	...
		                	tempBundle = new Bundle();
							tempBundle.putString("ProductPrice", AmazonCA_ProductPrice);
						...
						case OUTPUT:
							tempBundle = new Bundle();
							tempBundle.putString("TITLE_US", AmazonUS_ProductTitle);
							tempBundle.putString("PRICE_US", AmazonUS_ProductPrice);
							tempBundle.putString("PRICE_USJP", ExchangeRateUSJP_YenPrice);
							
							tempBundle.putString("TITLE_CA", AmazonCA_ProductTitle);
							tempBundle.putString("PRICE_CA", AmazonCA_ProductPrice);
